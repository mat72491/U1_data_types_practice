 ...
 */
const myFavoriteSong = 'The Boys of Summer'
...
let hometown = 'Yaphank'
let age = 33
//console.log(`Hi, my name is ${firstName}. I am ${age} years old. I live in ${hometown}. `)
/*
 * Prompt 3:
 *
...
let movies = ['The Sound of Music', 'Avengers: Endgame', 'Star Wars']
console.log(movies[1])

movies.unshift('The Day After Tomorrow')
movies.push('The Wizard of Oz')
movies.splice(1, 0, 'Balto') //found splice function on Google
console.log(movies)
